...
const HandleSubmit = async e =>{
 ...
 try {
    ...
    if(onEdit){
        await axios.put(`http://45.132.240.106/admin/api/offer/${offer._id}` , {...offer ,img:images} ,
        {headers :{Authorization :token}}
    )}
    else{
        await axios.post('http://45.132.240.106/admin/api/offer' , {...offer ,img:images} ,
        {headers :{Authorization :token}})
    }
...
const styleUpload ={
    ...
    const deleteOffer = async() =>{
      console.log(offer)
      try {
        await axios.delete(`http://45.132.240.106/admin/api/offer/${offer._id}` ,{headers : {Authorization:token}})
        setCallback(!callback)
